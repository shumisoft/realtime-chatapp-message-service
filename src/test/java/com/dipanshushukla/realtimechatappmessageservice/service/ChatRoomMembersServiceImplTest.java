...
class ChatRoomMembersServiceImplTest {
    ...
    void unassignAdmin_Self_ThrowsException() {
        assertThrows(BadRequestException.class,
                () -> membersService.unassignAdmin(chatRoom.getChatId(), requester.getUserId(), requester.getUserId()));
    }
    ...
    void unassignAdmin_LastAdmin_ThrowsException() {
        ...
        BadRequestException ex = assertThrows(BadRequestException.class,
                () -> membersService.unassignAdmin(chatRoom.getChatId(), targetUser.getUserId(),
                        anotherAdminRequester.getUserId()));
